@extends('customer.invoice.allorders.base')
            ...
            <div class="container-fluid">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center mb-4">
                        ...
                        <a href="{{ url('customer/Allinvoices') }}" class="btn btn-dark ms-1">All Invoices</a>
                    </div>
                                    ...
                                    @if ($o->vectorId)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($o->paid_on == 1)
                                                    <a class="btn btn-sm btn-dark rounded-pill "
                                                        href="{{ route('customerinvoice.download', $o->invoiceId) }}">{{ $o->invoice_number }}</a>
                                                @endif
