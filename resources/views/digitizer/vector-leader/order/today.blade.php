@extends('digitizer.vector-leader.order.base')
        ...
        <div class="container-fluid">
            <div class="bg-light text-center rounded p-4">
                <div class="d-flex flex-column align-items-start justify-content-between mb-4">
                    <h6 class="mb-0">Today Vector Orders</h6>
                        ...
                        <tbody>
                            ...
                            <tr class="bg-danger bg-gradient text-white">
                                ...
                                <td>
                                    ...
                                    href="{{ route('all-leader-vector-order.show', ['all_leader_vector_order' => $q->order_id]) }}">Details</a>
                                </td>
                            </tr>
                            @endforeach
