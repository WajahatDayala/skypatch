    ...
    <table class="table table-bordered">
        <tbody>
            <tr class="row">
                ...
                <td>
                    <button type="button" class="btn btn-sm rounded-pill btn-primary m-2" data-bs-toggle="modal"
                        data-bs-target="#fileUploadModalA">
                        Upload Files
                    </button>
    ...
    <table class="table table-bordered">
        <tbody>
            ...
            <tr class="row">
                <td>
                    @foreach ($optionB as $b)
                        ...
                        @if ($filePath)
                            ...
                            |
                            <button type="button"
                                class="btn btn-sm rounded-pill btn-danger m-2 delete-file-btn-order-b"
                                data-file-id="{{ $fileId }}" data-bs-toggle="modal"
                ...
                <td>
                    <button type="button" class="btn btn-sm rounded-pill btn-primary m-2" data-bs-toggle="modal"
                        data-bs-target="#fileUploadModal">Upload Files</button>
                </td>
            </tr>
            <tr class="row">
                {{-- <td>
