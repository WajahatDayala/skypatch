@extends('admin.customers.customer-dashboard-invoice.invoice.base')
            ...
            <div class="container-fluid">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center mb-4">
                        <h6 class="mb-0 m-2">All Invoices</h6>
                        <a href="{{ url('customers/' . $user->id . '/allorders') }}" class="btn btn-dark ms-1">All Orders</a>
                      </div>
