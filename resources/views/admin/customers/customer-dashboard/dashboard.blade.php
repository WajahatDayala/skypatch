...
<div class="container-fluid pt-4 px-4">
    <div class="row g-4">
        ...
        <div class="col-sm-6 col-md-3 col-xl-3">
            <div class="card shadow-lg rounded d-flex flex-column align-items-center justify-content-center p-4">
                <a href="{{ url('customers/' . $user->id . '/my-profile') }}"><img class="icon-img-dashboard" src="{{asset('skypatch/img/icons/profile.png')}}" alt="" >
    ...
    <div class="row g-4 mt-3">
        ...
        <div class="col-sm-6 col-md-3 col-xl-3">
            <div class="card shadow-lg rounded d-flex flex-column align-items-center justify-content-center p-4">
            <a href="{{ url('customers/' . $user->id . '/order') }}"><img class="icon-img-dashboard" src="{{asset('skypatch/img/icons/place_order.png')}}" alt="" >
        ...
        <div class="col-sm-6 col-md-3 col-xl-3">
        <div class="card shadow-lg rounded d-flex flex-column align-items-center justify-content-center p-4">
        <a href="{{ url('customers/' . $user->id . '/vector-order') }}"> <img class="icon-img-dashboard" src="{{asset('skypatch/img/icons/add-vector.png')}}" alt="" >
    ...
    <div class="row g-4 mt-3">
        ...
        <div class="col-sm-6 col-md-3 col-xl-3">
            <div class="card shadow-lg rounded d-flex flex-column align-items-center justify-content-center p-4">
            <a href="{{url('customers/'.$user->id.'/all-orders')}}"> <img class="icon-img-dashboard" src="{{asset('skypatch/img/icons/All_Orders.png')}}" alt="" >
        ...
        <div class="col-sm-6 col-md-3 col-xl-3">
          <div class="card shadow-lg rounded d-flex flex-column align-items-center justify-content-center p-4">
          <a href="{{url('customers/'.$user->id.'/all-vector-orders')}}">  <img class="icon-img-dashboard" src="{{asset('skypatch/img/icons/All_Vector.png')}}" alt="" >
