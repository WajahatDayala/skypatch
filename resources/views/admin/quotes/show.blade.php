            ...
            <div class="bg-table rounded h-100 p-4">
                <div class="row mb-4">
                    ...
                    <div class="col-6 d-flex align-items-center justify-content-end">
                        <button type="button"  class="btn btn-sm btn-primary rounded-pill me-2">Print</button>
                        @if($order->edit_status == 1)
                        <a href="{{route('allquotes.edit', ['allquote', $order->order_id])}}"
                         class="btn btn-sm btn-primary rounded-pill me-2">Edit</button>
                            <a href="{{route('allquotes.edit', ['allquote', $order->order_id])}}"
                        ...
                        <tr class="row">
                                            ...
                                            <form id="instructionForm" method="POST"
                                                ...
                                                <div class="modal-body">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" hidden id="customer_id"
                                                            name="customer_id" required value="{{$order->customer_id}}">
                                                    </div>
                                                    <div class="form-group">
                                                        <label hidden for="order_id">Quote ID</label>
                                                        <input type="text" hidden class="form-control"  id="order_id"
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" id="instruction"
                                                            ...
                                                            required>{{ $orderInstruction ? $orderInstruction->instruction : 'No instruction available.' }}</textarea>
                                                    </div>
                            ...
                            <td class="col-6">
                                ...
                                <p>{{ $adminInstruction ? $adminInstruction->instruction : 'No instruction available.' }}
                                    ...
                                    @if($order->edit_status == 1)
                                        <button type="button" class="btn btn-primary rounded-pill" data-bs-toggle="modal"
                                            data-bs-target="#adminInstructionModal">
                                            Update
                                        </button>
                                    @endif
                                </p>
                                            ...
                                            <form id="adminInstructionForm" method="POST"
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" id="admin_instruction"
                                                            name="admin_instruction" rows="3"
                                                            required>{{ $adminInstruction ? $adminInstruction->instruction : 'No instruction available.' }} </textarea>
                                                    </div>
                                                </div>
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary"
                                        ...
                                        @if(!$order->designer_id)
                                            ...
                                            <strong>
                                                <a href="#" class="text-danger" data-bs-toggle="modal"
                                                    data-bs-target="#Designer" data-id="{{ $order->order_id }}">Not Assigned</a>
                                            </strong>
                                        @else
                                            <strong class="text-info" data-bs-toggle="modal" data-bs-target="#Designer"
                                                data-id="{{ $order->order_id }}" data-leader-id="{{ $order->designer_id }}">
                                                {{ $order->designer_name }}
                                            </strong>
                                        @endif
                                    </h6>
                            ...
                            @if($order->edit_status == 1)
                                <td class="col-3">
                                    ...
                                    <p class="mb-2">{{$order->order_status_name}} |
                                        ...
                                        <button type="button" class="btn btn-sm rounded-pill btn-dark ms-2" data-file-id=""
                                            data-bs-toggle="modal" data-bs-target="#orderStatusModal">Update</button>
                                    ...
                                    <div class="modal fade" id="orderStatusModal" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="orderStatusModalLabel">Update Quote Status
                                                    </h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                            ...
                            <td class="col-6">
                                ...
                                @foreach($orderFiles as $f)
                                                                ...
                                                                <span class="text-info">{{ $originalFilename }}
                                                                    @if($order->edit_status == 1) |
                                                                        <button type="button" class="btn btn-sm rounded-pill btn-danger m-2 delete-file-btn"
                                                                            data-file-id="{{ $fileId }}" data-bs-toggle="modal"
                                                                            data-bs-target="#deleteFileModal">Delete</button><br>
                                                                    @endif
                                                                </span>
                                @endforeach
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form id="deleteFileForm" method="POST"
                                                    action="{{ route('allquotes.deleteFile') }}">
                                                    @csrf
                                ...
                                @if($order->edit_status == 1)
                                    <button type="button" class="btn btn-sm rounded-pill btn-primary m-2"
                                        data-bs-toggle="modal" data-bs-target="#fileUploadModal">Attach Files</button>
                                @endif
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                            ...
                                            <form id="fileUploadForm" method="POST"
                                                action="{{ route('allquotes.uploadFile')}}"
