        ...
        <table class="email-container" role="presentation">
            <tr>
                <td>
                    ...
                    <!-- Two-column table for Option A and Option B -->
                    ...
                    <div class="attachment-mention">
                        <p><strong>Note:</strong> The details of Option A and Option B are provided above. Please find the attached files with this quote. Let us know if you have any questions or require further information.</p>
                    </div>
