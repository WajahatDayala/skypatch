            ...
            <div class="bg-light text-center rounded p-4">
                <div class="d-flex flex-column align-items-start justify-content-between mb-4">
                 ...
                 <div class="row">
                                 ...
                                 <div class="col-lg-4 "></div>
                                <div class="col-lg-4 col-xs-offset-right-12"><a style="margin-left: 70%; color:#fff;" class="btn btn-rounded btn-primary mb-3" href="{{url('/sales/sales-employees/create')}}"><i class="fa fa-plus">Add New</i></a></div>
                                </div>
