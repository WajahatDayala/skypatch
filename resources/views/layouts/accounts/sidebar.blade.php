   ...
   <div class="sidebar pe-4 pb-3">
      <nav class="navbar bg-outer navbar-light d-flex flex-column align-items-center justify-content-center">
        ...
        <div class="navbar-nav w-100">
          ...
          <a href="{{url('/accounts/account-todayquotes')}}" class="nav-item nav-link {{ request()->is('accounts/account-todayquotes') ? 'active' : '' }}"><i class="fa-solid fa-quote-left me-2"></i>Today's Quote</a>
         ...
         <a href="{{url('/accounts/account-today-orders')}}" class="nav-item nav-link {{ request()->is('accounts/account-today-orders') ? 'active' : '' }}"><i class="fa-solid fa-pen-to-square me-2"></i>
          Today's Order </a> 

          <a href="{{url('/accounts/account-today-edit-orders')}}" class="nav-item nav-link {{ request()->is('accounts/account-today-edit-orders') ? 'active' : '' }}"><i class="fa-solid fa-pen-to-square me-2"></i>
          ...
          <a href="{{url('/accounts/account-today-vector')}}" class="nav-item nav-link {{ request()->is('accounts/account-today-vector') ? 'active' : '' }}"><i class="fa-solid fa-pen-to-square me-2"></i>
          Today's Vector</a> 
