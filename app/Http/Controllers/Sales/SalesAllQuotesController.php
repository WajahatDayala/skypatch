...
class SalesAllQuotesController extends Controller
{
    /**
    ...
    public function toDayQuote()
    {
        ...
        return view('sales/quotes/today',
        [
        'quotes'=>$quotes
        ]);
    }
    ...
    public function show(string $id)
    {
        ...
        return view('sales/quotes/show',compact(
            'order',
            'designer',
            'orderStatus',
            'orderFiles',
    ...
    ->where('pricing_criterias.customer_id',$quote->customer_id)
     ...
     ->first();
        ...
        return view('sales/quotes/process',compact(
            'quote',
            'designer',
            'quoteStatus',
            'orderFiles',
