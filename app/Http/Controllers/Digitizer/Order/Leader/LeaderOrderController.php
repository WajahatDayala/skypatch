...
class LeaderOrderController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('digitizer/order-leader/order/index',['orders'=>$orders]);
    }
    ...
    public function todayDayOrders()
    {
        ...
        return view('digitizer/order-leader/order.today', ['orders' => $orders]);
    }
    ...
    public function show(string $id)
    {
        ...
        ->get();
         ...
         return view('digitizer/order-leader/order/show',compact(
            'order',
            'designer',
            'orderStatus',
            'orderFiles',
