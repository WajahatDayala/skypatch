...
class AccountVectorOrdersController extends Controller
{
    ...
    public function show(string $id)
    {
        ...
        return view('accounts/vector-orders/show',compact(
            'order',
            'orderStatus',
            'orderFiles',
            'designer',
    ...
    public function processOrder(string $id)
    {
     ...
     ->first();
        ...
        return view('accounts/vector-orders/process', compact(
            'order',
            'designer',
            'orderStatus',
            'orderFiles',
       ...
       public function sendEmailAndOrder(Request $request)
       {
           ...
           return redirect()->route('account-allvectors.show',$request->order_id)->with('success', 'Vector Order updated successfully!');
    ...
    public function edit(string $id)
    {
        ...
        return view('accounts/vector-orders/edit',compact(
            'order',
            'quoteFiles',
            'requiredFormat',
            'orderInstruction'
